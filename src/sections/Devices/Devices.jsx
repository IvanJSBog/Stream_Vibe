  ...
  const deviceItems = [
    {
      ...
      imageSrc: "/images/devices/1.svg",
    },
    {
      title: "Tablet",
      description:
        "StreamVibe is optimized for both Android and iOS smartphones. Download our app from the Google Play Store or the Apple App Store",
      imageSrc: "/images/devices/2.svg",
    },
    {
      title: "Smart TV",
      description:
        "StreamVibe is optimized for both Android and iOS smartphones. Download our app from the Google Play Store or the Apple App Store",
      imageSrc: "/images/devices/3.svg",
    },
    {
      title: "Laptops",
      description:
        "StreamVibe is optimized for both Android and iOS smartphones. Download our app from the Google Play Store or the Apple App Store",
      imageSrc: "/images/devices/4.svg",
    },
    {
      title: "Gaming Consoles",
      description:
        "StreamVibe is optimized for both Android and iOS smartphones. Download our app from the Google Play Store or the Apple App Store",
      imageSrc: "/images/devices/5.svg",
    },
    {
      title: "VR Headsets",
      description:
        "StreamVibe is optimized for both Android and iOS smartphones. Download our app from the Google Play Store or the Apple App Store",
      imageSrc: "/images/devices/6.svg",
    },
  ]
  return (
    <Section
    ...
    >
      <Grid columns={3}>
        {deviceItems.map((deviceItem, i) => (
          <DeviceCard {...deviceItem} key={i} />
        ))}
      </Grid>
    </Section>
  )
